            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                    	...
                    	<li> <a href="{{url('/CourseIndex')}}" ><span> <i class="fab fa-discourse"></i> </span><span class="hide-menu">OurCourse</span></a></li>
                        <li> <a href="{{url('/HomeProject')}}" ><span> <i class="fas fa-project-diagram"></i> </span><span class="hide-menu">Project</span></a></li>
                        <li> <a href="{{url('/contact')}}" ><span> <i class="fas fa-project-diagram"></i> </span><span class="hide-menu">contact</span></a></li>
                        <li> <a href="{{url('/RivewIndex')}}" ><span> <i class="fas fa-project-diagram"></i> </span><span class="hide-menu">Rivew</span></a></li>
					</ul>
                </nav>
            </div>
        </aside>
