<div id="contactTable" class="container-fluid section-marginTop parallax text-center">
    <div class="row ">
        ...
        <div class="col-md-4 contact-form">
            ...
            <div class="form-group">
                <input id="phone" type="text" class="form-control  w-100" placeholder="মোবাইল নং ">
            </div>
            <div class="form-group">
                <input id="emaile" type="text" class="form-control  w-100" placeholder="ইমেইল ">
            </div>
            <div class="form-group">
                <input id="msg" type="text" class="form-control  w-100" placeholder="মেসেজ ">
            </div>
            <button id="sendContact" type="submit" class="btn btn-block normal-btn w-100">পাঠিয়ে দিন </button>
        </div>
        <div class="col-md-2">
