<div class="container section-marginTop text-center">
    ...
    <div class="row">
        <div id="one"  class="owl-carousel mb-4 owl-theme">
            @foreach($ProjectDataKey as $ProjectDataKey)
                <div class="item m-1 card">
                    <div class="text-center">
                        <img class="" src="{{$ProjectDataKey->project_img}}" alt="Card image cap">
                        <h5 class="service-card-title mt-4">{{$ProjectDataKey->project_name}}</h5>
                        <h6 class="service-card-subTitle p-0 m-0">{{$ProjectDataKey->project_description}} </h6>
